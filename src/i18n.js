    ...
    tr: {
        translation: {
            "app": {
                ...
                "cloudPowered": "Bulut Altyapısı",
                "badge": "Dosyalarınızı Arındırın. Gizliliğinizi Koruyun.",
                "heroHeadlineLine1": "Metadatayı Temizleyin.",
                "heroHeadlineLine2": "Asıl Önemli Olanı ",
                "heroHeadlineMatters": "Koruyun.",
                "heroDesc": "Kürdan, dosyalarınızın içine gizlenmiş verileri anında siler; böylece her şeyi güvenle paylaşabilirsiniz.",
                "statsTrustedBy": "Gizliliğine önem verenlerin tercihi",
                "howItWorks": "Nasıl Çalışır?",
                "howItWorksTitle": "Sade. Gizli. Güçlü.",
                "step1Title": "1. Yükleyin",
                "step1Desc": "Dosyalarınızı sürükleyin ya da seçin.",
                "step2Title": "2. Arındıralım",
                "step2Desc": "Gizli veriler saniyeler içinde silinir.",
                "step3Title": "3. İndirin",
                "step3Desc": "Temizlenmiş dosyalarınız paylaşıma hazır."
            },
            "home": {
                "dropzoneTitle": "Dosyalarınızı buraya bırakın",
                "dropzoneSubtitle": "ya da tıklayıp seçin",
                "dropzoneNote": "Görsel (JPEG, PNG, WebP), Ses (MP3), PDF ve Ofis belgeleri desteklenir",
