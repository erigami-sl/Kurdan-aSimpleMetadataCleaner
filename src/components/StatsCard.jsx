...
export default function StatsCard({ totalCleaned }) {
    ...
    return (
        <div className="w-full bg-white dark:bg-[var(--color-dark-card)] rounded-[var(--radius-lg)] shadow-organic border border-cream-300 dark:border-[var(--color-dark-border)] p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-8 mb-20 z-10 relative transition-colors duration-300">
            <div className="flex items-center gap-6">
                ...
                <div>
                    <div className="font-serif text-4xl text-ink-900 dark:text-cream-50 font-medium mb-1 transition-colors">
